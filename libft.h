...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/25 11:10:41 by eubotnar          #+#    #+#             */
/*   Updated: 2019/01/25 11:10:43 by eubotnar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				*ft_memccpy(void *to,\
	const void *from, int ch, size_t numbytes);
void				*ft_memmove(void *to,\
	const void *from, size_t numbytes);
